...
time java -Xmx16g -jar $EBROOTVARSCAN/VarScan.v2.4.2.jar somatic \
...
time java -Xmx16g -jar $EBROOTVARSCAN/VarScan.v2.4.2.jar somaticFilter $VarScan_outfolder/1mpileup-CMT-2_removed_realigned_Varscan.snp.vcf \
--min-coverage 8 \
-–min-reads2 2 \
-–min-var-freq 0.08 \
--p-value 0.05 \
...
time java -Xmx16g -jar $EBROOTVARSCAN/VarScan.v2.4.2.jar somaticFilter $VarScan_outfolder/1mpileup-CMT-2_removed_realigned_Varscan.indel.vcf \
--min-coverage 8 \
-–min-reads2 2 \
-–min-var-freq 0.08 \
--p-value 0.05 \
...
cat $VarScan_outfolder/1mpileup-CMT-2_Varscan.vcf.snp_filtered.vcf | awk '{if ($7=="PASS") {print $0}}' > $VarScan_outfolder/1mpileup-CMT-2_Varscan.vcf.snp_filtered.vcf-PASS.vcf

cat $VarScan_outfolder/1mpileup-CMT-2_Varscan.vcf.indel_filtered.vcf | awk '{if ($7=="PASS") {print $0}}' > $VarScan_outfolder/1mpileup-CMT-2_Varscan.vcf.indel_filtered.vcf-PASS.vcf


time java -Xmx16g -jar $EBROOTVARSCAN/VarScan.v2.4.2.jar limit $VarScan_outfolder/1mpileup-CMT-2_Varscan.vcf.snp_filtered.vcf-PASS.vcf \
--regions-file $reference/Uniq-Canis_familiaris.CanFam3.1.99.gtf-chr1-38X-CDS-forDepthOfCoverage.interval_list_tab \
--output-file $VarScan_outfolder/CDS-1mpileup-CMT-2_Varscan.vcf.snp_filtered.vcf-PASS.vcf


time java -Xmx16g -jar $EBROOTVARSCAN/VarScan.v2.4.2.jar limit $VarScan_outfolder/1mpileup-CMT-2_Varscan.vcf.indel_filtered.vcf-PASS.vcf \
--regions-file $reference/Uniq-Canis_familiaris.CanFam3.1.99.gtf-chr1-38X-CDS-forDepthOfCoverage.interval_list_tab \
--output-file $VarScan_outfolder/CDS-1mpileup-CMT-2_Varscan.vcf.indel_filtered.vcf-PASS.vcf
